...
+import { Heart, Sparkles, Lock, Play, ShoppingCart, Settings, BarChart3 } from 'lucide-react';
...
+              className="p-3 bg-slate-700/50 hover:bg-slate-600/50 text-white rounded-lg transition-colors"
+            >
