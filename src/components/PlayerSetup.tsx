...
+import { Users, Settings, Plus, Trash2, Heart, Target } from 'lucide-react';
...
+                    <option value="player1">Joueur 1 uniquement</option>
+                    <option value="player2">Joueur 2 uniquement</option>
+                  </select>
+                </div>
+                
                 <div className="mb-4">
...
+                      {newChallenge.text.length}/200 caractères
+                    </span>
+                  </div>
                 </div>
...
+                      {challenge.target && challenge.target !== 'both' && (
+                        <span className="inline-block px-2 py-1 rounded text-xs font-medium mr-2 bg-amber-500/20 text-amber-300">
+                          {challenge.target === 'player1' ? 'J1' : 'J2'}
+                        </span>
+                      )}
